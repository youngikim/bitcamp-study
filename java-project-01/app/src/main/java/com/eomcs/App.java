...
//18. 데이터 목록을 다루는 코드를 재사용하기 쉽게 별도의 클래스로 분리한다. 15:58
//19. 메뉴 선택 기능을 추가
//20. 리팩토링: extract method -> 게시글 관리 메뉴 처리 코드를 별도의 메서드로 분리한다. 42:25
//21. 리팩토링: 
//      - move method -> 게시글을 다루는 일은 BoardHandler에게 맡긴다. 45:02 
//      - move class -> Board 클래스를 사용하는 BoardHandler로 옮긴다.
//22. 회원 관리 기능을 추가하기
